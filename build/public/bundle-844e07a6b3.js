...
var require$$0 = ( preact$2 && preact ) || preact$2;
...
var index = { Provider: Provider$1, connect: connect$1, connectAdvanced: connectAdvanced };
...
// selectors
var getUrl = function (state) { return state.meta.url; };
...
var fetchBuoys = function (params) { return function (dispatch) {
  ...
  return index$2('/buoys', { params: params })
...
var login = function (ref) {
  ...
  index$2.post('/auth/login', { username: username, password: password })
  .then((function (ref) {
    var id = ref.data.id;
...
var signup = function (ref) {
  ...
  return function (dispatch) { return (
  index$2.post('/auth/signup', { username: username, password: password, passwordConf: passwordConf })
  .then((function (ref) {
    var id = ref.data.id;
...
var logout = function () { return function (dispatch) {
  ...
  return index$2('/auth/logout', { withCredentials: true })
...
var Header = function (ref) {
  ...
  return (
    h( 'header', { className: "Header" },
      h( 'nav', null,
        h( Link, { className: ("item " + (activeClass('/'))), href: "/", onClick: goTo('/') },
          h( 'i', { className: "material-icons" }, "home")
        ),
        h( Link, { className: ("item " + (activeClass('/favorites'))), href: "/favorites", onClick: goTo('/favorites') },
          h( 'i', { className: "material-icons" }, "star")
        ),
        isAuthenticated ?
          h( Link, { className: "item", href: "/logout", onClick: function () { return _logout(); } }, "Logout") :
          h( 'span', { className: "item", style: { display: 'flex' } },
            h( Link, { className: ("item " + (activeClass('/login'))), href: "/login", onClick: goTo('/login') }, "Login"),
            h( Link, { className: ("item " + (activeClass('/signup'))), href: "/signup", onClick: goTo('/signup') }, "Sign Up")
          )
      )
    )
  )
...
var Buoy = function (ref) {
  ...
  return (
    h( 'div', { className: "mdl-card card", style: { display: 'inherit' } },
      h( 'div', { className: "mdl-card__title" },
        h( 'h2', { className: "mdl-card__title-text", style: { width: '80%' } }, title),
        h( 'button', { className: "mdl-button mdl-button--icon mdl-card__menu", onClick: onClick },
          h( 'i', { className: "material-icons" },
            isFavorite ? 'star' : 'star_border'
          )
        )
      ),
      h( 'p', { className: "mdl-card__supporting-text t1" }, h( 'strong', null, "Last Update: " ), pubDate),
      h( 'p', { className: "mdl-card__supporting-text t1" }, h( 'strong', null, "Location: " ), location),
      h( 'div', { className: "data-wrap" },
        h( 'span', { className: "mdl-card__supporting-text" },
          h( 'h4', { className: "mdl-card__title-text" }, "Waves"),
          h( 'p', null, "Height: ", significantWaveHeight ),
          h( 'p', null, "Dominant Period: ", dominantWavePeriod ),
          h( 'p', null, "Average Period: ", averagePeriod ),
          h( 'p', null, "Direction: ", meanWaveDirection )
        ),
        h( 'span', { className: "mdl-card__supporting-text" },
          h( 'h4', { className: "mdl-card__title-text" }, "Wind"),
          h( 'p', null, "Direction: ", windDirection ),
          h( 'p', null, "Speed: ", windSpeed ),
          h( 'p', null, "Gust: ", windGust )
        ),
        h( 'span', { className: "mdl-card__supporting-text" },
          h( 'h4', { className: "mdl-card__title-text" }, "Temperature"),
          h( 'p', null, "Air: ", airTemperature ),
          h( 'p', null, "Water: ", waterTemperature )
        )
      ),
      h( 'p', { className: "mdl-card__actions", style: { textAlign: 'center' } }, "available at ", h( 'a', { href: link }, "ndbc.noaa.gov")
      )
    )
  )
};

var connect$3 = index.connect;
...
var Home = (function (Component$$1) {
  ...
  Home.prototype.render = function render$$1 (props) {
    ...
    if (props.error) { return h( 'h5', { className: "content" }, props.error) }
    var defaultText = h( 'h5', null, props.favs ? 'You have no favorites.' : 'No Buoys.' );
    var visibleBuoys = props.buoys
      .map((function (b) { return h( Buoy, {
...
var Home$1 = connect$3(mapStateToProps$1, { fetchBuoys: fetchBuoys, offlineFav: offlineFav })(Home);

var connect$4 = index.connect;
  ...
  Signup.prototype.render = function render$$1 (ref, ref$1) {
    ...
    return (
      h( 'div', { className: "Auth" },
        h( 'form', { className: "mx-auto", onSubmit: this.handleSubmit },
          h( 'h3', null, "Sign up" ),
          h( 'div', null,
            h( 'label', { htmlFor: "username" }, "Username"), h( 'br', null ),
            h( 'input', { required: true, id: "username", onInput: this.handleChange })
          ),
          h( 'div', null,
            h( 'label', { htmlFor: "password" }, "Password"), h( 'br', null ),
            h( 'input', { required: true, id: "password", type: "password", onInput: this.handleChange })
          ),
          h( 'div', null,
            h( 'label', { htmlFor: "passwordConf" }, "Confirm Password"), h( 'br', null ),
            h( 'input', { required: true, id: "passwordConf", type: "password", onInput: this.handleChange })
          ),
          h( 'button', { type: "submit" }, "Sign up"),
          h( 'div', { className: "error" }, err || error)
        )
      )
    )
  };
...
var Signup$1 = connect$4((function (state) { return ({ error: state.user.error.signup }); }), { signup: signup })(Signup);

var connect$5 = index.connect;
...
var Login$1 = connect$5((function (state) { return ({ error: state.user.error.login }); }), { login: login })(Login);

var FourOhFour = function () { return (
  h( 'div', { className: 'FourOhFour page' },
    h( 'h1', null, "Dag nab it!" ),
    h( 'p', null, "The url you are trying cannot be found." )
  )
); };

var Provider$$1 = index.Provider;
var connect$$1 = index.connect;

var mapStateToProps = function (state) { return ({ pathname: getPathname(state) }); };

var Content = connect$$1(mapStateToProps)((function (ref) {
  var pathname = ref.pathname;

  if (pathname === '/') { return h( Home$1, null ) }
  else if (pathname === '/favorites') { return h( Home$1, { favs: true }) }
  else if (pathname === '/login') { return h( Login$1, null ) }
  else if (pathname === '/signup') { return h( Signup$1, null ) }
  return h( FourOhFour, null )
}));
...
function isStatePlainEnough(a) {
  ...
  if (!isPlainObject$1(a)) return false;
  return true;
}
...
function defaultStateReconciler(state, inboundState, reducedState, log) {
  var newState = _extends$2({}, reducedState);
  ...
  Object.keys(inboundState).forEach((function (key) {
    ...
    if (isStatePlainEnough(inboundState[key]) && isStatePlainEnough(state[key])) newState[key] = _extends$2({}, state[key], inboundState[key]); // shallow merge
...
function _hasStorage(storageType) {
  if ((typeof window === 'undefined' ? 'undefined' : _typeof$3(window)) !== 'object' || !(storageType in window)) {
    return false;
  }
...
function getStoredState(config, onComplete) {
  ...
  if (storage.keys && !storage.getAllKeys) storage = _extends$3({}, storage, { getAllKeys: storage.keys });
...
function persistStore(store) {
  ...
  if ("production" !== 'production' && config.skipRestore) console.warn('redux-persist: config.skipRestore has been deprecated. If you want to skip restoration use `createPersistor` instead');
...
var send = function send(action, dispatch, config) {
  ...
  return config.effect(metadata.effect, action).then((function (result) {
    ...
    if (delay != null) {
      ...
      return dispatch((0, actions.scheduleRetry)(delay));
    } else {
  ...
  return function (store) {
    return function (next) {
      return function (action) {
        ...
        var state = store.getState();
        var actions$$1 = take(state, config);

        // if the are any actions in the queue that we are not
        // yet processing, send those actions
        if (actions$$1.length > 0 && !state.offline.busy && !state.offline.retryScheduled && state.offline.online) {
          send(actions$$1[0], store.dispatch, config, state.offline.retryCount);
        }
        ...
        if (action.type === constants.OFFLINE_SCHEDULE_RETRY) {
          ...
          after(action.payload.delay).then((function () {
            return store.dispatch((0, actions.completeRetry)(retryToken));
          }));
        }
        ...
        if (action.type === constants.OFFLINE_SEND && actions$$1.length > 0 && !state.offline.busy) {
          send(actions$$1[0], store.dispatch, config, state.offline.retryCount);
        }
...
var offlineUpdater = function offlineUpdater() {
  ...
  if (action.type === constants.OFFLINE_STATUS_CHANGED && action.payload && typeof action.payload.online === 'boolean') {
    return _extends({}, state, { online: action.payload.online });
  }

  if (action.type === constants.PERSIST_REHYDRATE) {
  ...
  if (action.type === constants.OFFLINE_BUSY && action.payload && typeof action.payload.busy === 'boolean') {
...
var _reduxPersist = ( index$7 && undefined ) || index$7;
...
exports.default = _reduxPersist.persistStore; // flow
}));

var persistStore$1 = unwrapExports(persist);
...
var _persist2 = _interopRequireDefault(persist);



var _detectNetwork2 = _interopRequireDefault(detectNetwork);
...
var _batch2 = _interopRequireDefault(batch);



var _retry2 = _interopRequireDefault(retry);



var _discard2 = _interopRequireDefault(discard);
...
var defaultConfig = unwrapExports(index$8);
...
var _defaults2 = _interopRequireDefault(index$8);
...
var require$$0$3 = ( index$1 && undefined ) || index$1;
...
var offline = exports.offline = function offline() {
  ...
  return function (createStore) {
    return function (reducer, preloadedState) {
      ...
      console.log('Creating offline store', config$$1);

      // wraps userland reducer with a top-level
      // reducer that handles offline state updating
      var offlineReducer = (0, updater.enhanceReducer)(reducer);

      var offlineMiddleware = (0, require$$0$3.applyMiddleware)((0, middleware.createOfflineMiddleware)(config$$1));

      // create autoRehydrate enhancer if required
      var offlineEnhancer = config$$1.persist && config$$1.rehydrate ? (0, require$$0$3.compose)(offlineMiddleware, enhancer, (0, _reduxPersist.autoRehydrate)()) : (0, require$$0$3.compose)(offlineMiddleware, enhancer);
      ...
      if (config$$1.persist) {
        persistor = config$$1.persist(store, config$$1.persistOptions, config$$1.persistCallback);
      }
...
var logOnlyInProduction_2 = logOnlyInProduction.devToolsEnhancer;
...
var IS_CLIENT = true; // eslint-disable-line

var createStore$1 = function () {
  var config = Object.assign({}, defaultConfig, {
    effect: function (effectConfig) { return index$2(effectConfig); },
    persist: function (store) { if (typeof self === 'object') { persistStore$1(store, { blacklist: ['meta', 'buoys'] }); } },
  });
  var enhancer = compose(
      applyMiddleware(thunk),
      IS_CLIENT ? logOnlyInProduction_2() : function (f) { return f; },
      index_1(config)
  );
...
var ensurePolyfills = function (callback) {
  if (
    'Promise' in window &&
    'assign' in Object
  ) {
...
ensurePolyfills((function () {
  var store = createStore$1(window.__STATE__);
